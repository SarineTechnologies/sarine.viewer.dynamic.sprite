    ...
    grunt.initConfig({
        ...
        coffee: {
            bundle: {
                ...
                files: {
                    'dist/<%= config.name %>.bundle.js' : [decideBaseViewer() + 'sarine.viewer/coffee/*.coffee', decideBaseViewer() + 'sarine.viewer.dynamic/coffee/*.coffee', 'coffee/*.coffee'] // concat then compile into single file
                }
            }
        },
        uglify: {
